...
activities = {
    ...
    "Art Studio": {
        ...
        "max_participants": 12,
        "participants": ["emily@mergington.edu", "sara@mergington.edu"]
    },
    "Drama Society": {
    ...
    "Science Olympiad": {
        "description": "Hands-on STEM challenges and competition prep",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
